...
globularsK2 = os.path.abspath("../singleLink/saidaSingleLink/globulars/k2.clu")
globularsK3 = os.path.abspath("../singleLink/saidaSingleLink/globulars/k3.clu")
globularsK4 = os.path.abspath("../singleLink/saidaSingleLink/globulars/k4.clu")
globularsK5 = os.path.abspath("../singleLink/saidaSingleLink/globulars/k5.clu")
...
spiralsK2 = os.path.abspath("../singleLink/saidaSingleLink/spirals/k2.clu")
spiralsK3 = os.path.abspath("../singleLink/saidaSingleLink/spirals/k3.clu")
spiralsK4 = os.path.abspath("../singleLink/saidaSingleLink/spirals/k4.clu")
spiralsK5 = os.path.abspath("../singleLink/saidaSingleLink/spirals/k5.clu")
...
monkeyK5 = os.path.abspath("../singleLink/saidaSingleLink/monkey/k5.clu")
monkeyK6 = os.path.abspath("../singleLink/saidaSingleLink/monkey/k6.clu")
monkeyK7 = os.path.abspath("../singleLink/saidaSingleLink/monkey/k7.clu")
monkeyK8 = os.path.abspath("../singleLink/saidaSingleLink/monkey/k8.clu")
monkeyK9 = os.path.abspath("../singleLink/saidaSingleLink/monkey/k9.clu")
monkeyK10 = os.path.abspath("../singleLink/saidaSingleLink/monkey/k10.clu")
monkeyK11 = os.path.abspath("../singleLink/saidaSingleLink/monkey/k11.clu")
monkeyK12 = os.path.abspath("../singleLink/saidaSingleLink/monkey/k12.clu")
